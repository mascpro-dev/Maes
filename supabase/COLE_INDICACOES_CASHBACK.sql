-- =============================================================================
-- COLE NO SUPABASE (SQL Editor) — Programa de indicação + cashback
-- =============================================================================
...
-- =============================================================================
-- Ativação manual (quando quiser começar com parceiros):
-- update public.partner_program_accounts
-- set enabled = true
-- where user_id = 'UUID_DA_UTILIZADORA';
-- =============================================================================
