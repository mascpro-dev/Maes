-- Colar no Supabase se ainda não aplicou a migration 20260409140000_feed_interaction_rpcs.sql
-- (Requer tabelas feed_post_likes e feed_post_comments já criadas.)
