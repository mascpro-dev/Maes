-- Candidaturas de profissionais parceiros (triagem antes de criar especialista na plataforma)
-- INSERT público (anon/authenticated); leitura só via service_role / Dashboard Supabase.
...
-- service_role ignora RLS e pode SELECT no Table Editor
