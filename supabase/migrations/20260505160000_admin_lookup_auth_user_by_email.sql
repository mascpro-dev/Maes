-- =============================================================================
-- Admin: descobrir UUID em auth.users pelo e-mail (evita colar UUID errado)
-- =============================================================================
...
GRANT EXECUTE ON FUNCTION public.admin_lookup_auth_user_by_email(text) TO authenticated;
