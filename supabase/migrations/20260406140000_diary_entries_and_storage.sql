-- =============================================================================
-- Aura — Diário de evolução clínica: tabela diary_entries + Storage diary-audio
-- =============================================================================
...
COMMENT ON TABLE public.diary_entries IS 'Registos do diário de evolução (marcos/crises, texto ou áudio).';

-- Bucket privado: caminho {auth.uid()}/{uuid}.{ext}
