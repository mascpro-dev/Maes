...
/**
 * URL pública do site (sem barra final), ex.: https://meusite.com
 * Opcional: só precisas se gerares links de indicação fora de https (ex.: ficheiro local).
 * Em produção em https, o link usa automaticamente o mesmo domínio da página aberta.
 */
